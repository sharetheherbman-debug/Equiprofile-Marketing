...
/**
 * AcademyDashboard — compatibility component for Academy owners.
 * Canonical Academy APIs are used while persisted role identifiers remain legacy-compatible where required.
...
export default function AcademyDashboard() {
  ...
  } = trpc.academy.getStats.useQuery();
  const {
    data: members,
