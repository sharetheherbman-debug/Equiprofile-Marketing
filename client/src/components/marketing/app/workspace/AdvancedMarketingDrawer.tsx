  ...
  return (
    <details className="rounded-3xl border border-stone-200 bg-white p-4 shadow-sm" open={open} onToggle={(event) => onOpenChange(event.currentTarget.open)}>
      ...
      <div className="mt-4 space-y-4 border-t border-stone-100 pt-4">
        <p className="text-xs leading-5 text-stone-600">Create optional media assets, manage Brand Kit details, or open connection settings without cluttering the campaign workflow.</p>
