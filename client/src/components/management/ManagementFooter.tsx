/**
 * ManagementFooter — public footer for equiprofile.online.
 *
 * Keep the EquiProfile product family easy to understand: Management is the
 * current surface, Academy is a separate learning product, and Shop is
 * deliberately presented as coming soon until its launch is approved.
 */
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-5 max-w-xs">
              Horse management and equestrian learning tools designed around
              real day-to-day care, training and progress.
            </p>
            <a
