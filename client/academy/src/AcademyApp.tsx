      ...
      <main id="main-content">
        <Suspense fallback={<PageSpinner />}>
          <Switch>
            ...
            {/* LEGACY_COMPAT_ONLY: /school route aliases */}
            ...
            {/* Academy invitation acceptance preserves the token through
                login; the API verifies the account-email match server-side. */}
            ...
            {/* Canonical Academy dashboard plus LEGACY_COMPAT_ONLY alias */}
