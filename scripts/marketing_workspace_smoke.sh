...
npx vitest run server/pr64h.aiGuidedWorkspace.test.ts server/pr64i.liveGenerationRenderHardening.test.ts server/pr64j.runtimeStorageRenderUx.test.ts -t "intent routing|preview, Library, Calendar, and Settings truth|UX and diagnostics visibility"
